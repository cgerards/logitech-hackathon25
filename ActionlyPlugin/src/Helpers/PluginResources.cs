namespace Loupedeck.ActionlyPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ActionlyPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ActionlyPlugin.Resources.Resource.txt`.
